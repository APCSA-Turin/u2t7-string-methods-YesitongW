...
public class CustomStringMethods {
  ...
  // WRITE AND TEST THE METHODS BELOW
    ...
    */
    public String halvesReversed(String myString) {
        ...
        String firstHalf = myString.substring(0, half);
        String secondHalf = myString.substring(half);
  ...
  */
  public String endUp(String myString, int numToCap){
      ...
      return myString.toUpperCase();  // Uppercase the whole string if numToCap exceeds length
  }
      int splitPoint = myString.length() - numToCap;
      return myString.substring(0, splitPoint) + myString.substring(splitPoint).toUpperCase();
  }
